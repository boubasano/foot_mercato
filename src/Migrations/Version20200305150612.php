 ...
 */
final class Version20200305150612 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX id_annonceagent ON annonceagent');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX id_annonceagent ON annonceagent (id_annonceagent)');
