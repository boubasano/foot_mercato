 ...
 */
final class Version20200324161539 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE agent (id_agent INT AUTO_INCREMENT NOT NULL, nom_agent VARCHAR(255) NOT NULL, prenom_agent VARCHAR(255) NOT NULL, email_agent VARCHAR(255) NOT NULL, password_agent VARCHAR(255) NOT NULL, pays_agent VARCHAR(255) NOT NULL, ville_agent VARCHAR(255) NOT NULL, continent_agent VARCHAR(255) NOT NULL, PRIMARY KEY(id_agent)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE club (id_club INT AUTO_INCREMENT NOT NULL, nom_club VARCHAR(255) NOT NULL, pays_club VARCHAR(255) NOT NULL, ville_club VARCHAR(255) NOT NULL, continent_club VARCHAR(255) NOT NULL, email_club VARCHAR(255) NOT NULL, password_club VARCHAR(255) NOT NULL, PRIMARY KEY(id_club)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE joueur (id_joueur INT AUTO_INCREMENT NOT NULL, nom_joueur VARCHAR(255) NOT NULL, prenom_joueur VARCHAR(255) NOT NULL, email_joueur VARCHAR(255) NOT NULL, password_joueur VARCHAR(255) NOT NULL, pays_joueur VARCHAR(255) NOT NULL, ville_joueur VARCHAR(255) NOT NULL, continent_joueur VARCHAR(255) NOT NULL, PRIMARY KEY(id_joueur)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
